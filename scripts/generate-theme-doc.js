...
const createRepoMdLink = (theme) => {
  return `\n[${theme}_repo]: https://git_stats.vercel.app/api/pin/?username=Ubaidd1&repo=git_stats&cache_seconds=86400&theme=${theme}`;
};
const createStatMdLink = (theme) => {
  return `\n[${theme}]: https://git_stats.vercel.app/api?username=Ubaidd1&show_icons=true&hide=contribs,prs&cache_seconds=86400&theme=${theme}`;
};
